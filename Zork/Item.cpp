...
Item::Item(const string name, const string description, Entity* parent, const bool can_grab, const bool can_read, const string read_text, const bool can_turn_on,
	const bool can_contain, const bool can_move, const bool can_break, const bool can_use, const int damage_points) : Entity(name, description, parent, ITEM), can_grab(can_grab), can_read(can_read), read_text(read_text),
